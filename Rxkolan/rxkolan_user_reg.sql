...
CREATE TABLE `user_reg` (
  ...
  `Service_Offer` varchar(200) DEFAULT NULL,
  `Spciality` varchar(300) DEFAULT NULL,
  `user_regcol` varchar(45) DEFAULT NULL,
  `Status` varchar(45) DEFAULT NULL,
  `Status_Updated_By` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Phone`)
...
-- Dump completed on 2023-07-05  8:33:52
