...
CREATE TABLE `sale_invoice` (
  `Sale_Invoice_No` varchar(45) NOT NULL,
  `customer_phone` int NOT NULL,
  `Inv_Date` varchar(45) DEFAULT NULL,
  `Total_sale_Inv_Amt` varchar(45) DEFAULT NULL,
  `Loyalty_Points` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Sale_Invoice_No`)
...
-- Dump completed on 2023-07-05  8:29:23
