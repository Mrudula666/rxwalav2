...
--
-- Table structure for table `distributor_stock_online`
--

DROP TABLE IF EXISTS `distributor_stock_online`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `distributor_stock_online` (
  ...
  `Retailer_Order` varchar(1) DEFAULT NULL,
  `Retailer_Display` varchar(1) DEFAULT NULL,
...
--
-- Dumping data for table `distributor_stock_online`
--

LOCK TABLES `distributor_stock_online` WRITE;
/*!40000 ALTER TABLE `distributor_stock_online` DISABLE KEYS */;
/*!40000 ALTER TABLE `distributor_stock_online` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-05  8:33:10
