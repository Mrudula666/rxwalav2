...
CREATE TABLE `tab_store_user_login` (
  ` store_ user_ full_name` varchar(100) NOT NULL,
  `store_user_phone number` int NOT NULL,
  `store_user_email id` varchar(100) NOT NULL,
  ...
  PRIMARY KEY (`store_user_phone number`,`store_user_email id`)
